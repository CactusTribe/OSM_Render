...
void drawWay(SDL_Renderer *ren, OSM_Way *way){
	...
	if(strcmp(way->tagList[0].v, "primary") == 0 || strcmp(way->tagList[0].v, "secondary") == 0 || strcmp(way->tagList[0].v, "tertiary") == 0
		|| strcmp(way->tagList[0].v, "unclassified") == 0 || strcmp(way->tagList[0].v, "residential") == 0 || strcmp(way->tagList[0].v, "service") == 0
		|| strcmp(way->tagList[0].v, "living_street") == 0 || strcmp(way->tagList[0].v, "pedestrian") == 0){

		
		if(strcmp(way->tagList[0].v, "primary") == 0){
			weigth = 25;
			rgb_IN = primary_IN;
			rgb_OUT = primary_OUT;
		}
		else if(strcmp(way->tagList[0].v, "secondary") == 0){
			weigth = 25;
			rgb_IN = secondary_IN;
			rgb_OUT = secondary_OUT;
		}
		else if(strcmp(way->tagList[0].v, "tertiary") == 0){
			weigth = 25;
			rgb_IN = tertiary_IN;
			rgb_OUT = tertiary_OUT;
		}
		else if(strcmp(way->tagList[0].v, "unclassified") == 0){
			weigth = 15;
			rgb_IN = unclassified_IN;
			rgb_OUT = unclassified_OUT;
		}
		else if(strcmp(way->tagList[0].v, "residential") == 0){
			weigth = 15;
			rgb_IN = residential_IN;
			rgb_OUT = residential_OUT;
		}
		else if(strcmp(way->tagList[0].v, "service") == 0){
			weigth = 8;
			rgb_IN = service_IN;
			rgb_OUT = service_OUT;
		}
		else if(strcmp(way->tagList[0].v, "living_street") == 0){
			weigth = 15;
			rgb_IN = living_street_IN;
			rgb_OUT = living_street_OUT;
		}
		else if(strcmp(way->tagList[0].v, "pedestrian") == 0){
			weigth = 15;
